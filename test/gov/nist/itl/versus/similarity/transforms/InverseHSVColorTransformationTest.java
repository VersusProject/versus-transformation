...
import gov.nist.itl.versus.similarity.transforms.InverseHSVColorTransformation;
import gov.nist.itl.versus.similarity.transforms.Transformations;

public class InverseHSVColorTransformationTest {
	@Test
	public void testTransform() throws IOException, VersusException, ImageException, IncompatibleBitDepthException {
		...
		ImageObject imgObj = readerwriter.readImage(
				"C:\\Users\\cng1\\Documents\\TestImages\\R is GplusB hsv.tif",
				null, 1);
		Adapter img = (Adapter) new ImageObjectAdapter(imgObj);
		Transformations trans = (Transformations) new InverseHSVColorTransformation(img);
		Adapter result = trans.transform();
		ImageObject imgObjRes = ((ImageObjectAdapter) result).getImageObject();
		readerwriter
				.writeImage(
						"C:\\Users\\cng1\\Documents\\TestImages\\R is GplusB hsv inv.tif",
						imgObjRes);
