...
import gov.nist.itl.versus.similarity.transforms.GaborTransformation;
import gov.nist.itl.versus.similarity.transforms.Transformations;

public class GaborTransformationTest {
	...
	public void testTransform() throws IOException, VersusException, ImageException, IncompatibleBitDepthException {
		...
		ImageObject imgObj = readerwriter.readImage(
				"C:\\Users\\cng1\\Documents\\TestImages\\fakeheart.tif",
				null, 1);
		...
		readerwriter
				.writeImage(
						"C:\\Users\\cng1\\Documents\\TestImages\\fakeheart gabor.tif",
						imgObjRes);
