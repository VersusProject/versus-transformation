...
/**
 * 
 * A Colorspace Transformation from RGB to Grayscale for an gov.nist.itl.versus.similarity.adapter 
...
public class GrayColorTransformation extends ColorTransformation {
	...
	/**
	 * constructs and loads an gov.nist.itl.versus.similarity.adapter into an instance of GrayColorTransformation
	 * by calling the ColorTransformation super class and changing the settings
	 */
