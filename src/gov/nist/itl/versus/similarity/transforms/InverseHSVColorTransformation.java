...
/**
 * 
 * A Colorspace Transformation from HSV to RGB for an gov.nist.itl.versus.similarity.adapter 
...
public class InverseHSVColorTransformation extends ColorTransformation {
	...
	/**
	 * constructs and loads an gov.nist.itl.versus.similarity.adapter into an instance of InverseHSVColorTransformation
	 * by calling the ColorTransformation super class and changing the settings
	 */
