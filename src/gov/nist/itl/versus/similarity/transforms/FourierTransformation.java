...
/**
 * 
 * Implements a Fourier Transformation from Fiji for an gov.nist.itl.versus.similarity.adapter
 * 
...
public class FourierTransformation implements Transformations {
	...
	/**
	 * loads an instance of FourierTransformation with an gov.nist.itl.versus.similarity.adapter to be
	 * processed
	 * 
	 * @param gov.nist.itl.versus.similarity.adapter
	 *            an gov.nist.itl.versus.similarity.adapter containing an image to be processed
	 ...
	 * gov.nist.itl.versus.similarity.adapter pass to it and returns another gov.nist.itl.versus.similarity.adapter with the image of the
	 ...
	 * **************** ----- check gov.nist.itl.versus.similarity.adapter compatibility. --- ****************
	 * **************** -------------------------------------- ****************
	 * ************************************************************************
	 * ************************************************************************
	 */
